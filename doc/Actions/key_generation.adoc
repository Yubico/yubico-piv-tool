...
|-i, --input       | | X | Filename to use as input | file name or "-" for stdin. Supported format for public key: PEM | -
|-o, --output      | | X | Filename to use as output | file name or "-" for stdout | -
