...
macro (find_pcscd)
    ...
    if(${BACKEND} STREQUAL ${BACKEND_ARG_CHECK})
        if(${CMAKE_SYSTEM_NAME} MATCHES "*Darwin*" OR ${CMAKE_SYSTEM_NAME} MATCHES "*darwin*")
            message("Detected Mac: selecting ${BACKEND_ARG_MAC} backend")
            set(BACKEND ${BACKEND_ARG_MAC})
        elseif(if(${CMAKE_SYSTEM_NAME} MATCHES "*Win*" OR ${CMAKE_SYSTEM_NAME} MATCHES "*win*"))
    ...
    if(${BACKEND} STREQUAL ${BACKEND_ARG_WIN})
        ...
        else(WINSCARD_H_FOUND)
            message(FATAL_ERROR "cannot find Windows PCSC library/headers")
        endif(WINSCARD_H_FOUND)
